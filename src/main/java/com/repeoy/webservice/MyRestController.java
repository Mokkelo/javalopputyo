...
public class MyRestController {
    ...
    public List<ToCourse> addToCourse(@RequestParam String name) {
        return getStudents();
    ...
    public List<Student> addStudent(@RequestParam String fName,
                                    ...
                                    @RequestParam int[] kurssit){
        Student e = new Student(fName,lName,number, address, opiskelijaID, kurssit);
        students.add(e);
        return getStudents();
    }
